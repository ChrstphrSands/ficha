...
class Paso2 extends React.Component {
    ...
    getCiudades() {
        fetch(`http://172.35.123.9/FichaWeb/app/controller/ciudad/read.php?idPais=${this.state.idPais}`)
            .then(response => response.json())
            .then(data => this.setState({ciudades: data}));
    }

    getProvincias() {
        fetch('http://172.35.123.9/FichaWeb/app/controller/provincia/read.php/?idCiudad=2919')
            .then(response => response.json())
            .then(data => this.setState({provincias: data}));
    }

    getDistritos() {
        fetch('http://172.35.123.9/FichaWeb/app/controller/distrito/read.php/?idPais=9589&idCiudad=2919&idProvincia=2301')
            .then(response => response.json())
